...
def parse_args():
    ...
    parser.add_argument('--dataset', type=str, default="all", help='Run which data.')
    ...
    parser.add_argument('--sequence_length', type=int, default=100000, help='Set the sequence length to run the model.')
